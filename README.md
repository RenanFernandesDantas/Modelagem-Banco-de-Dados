...
Durante a elaboração desta entrega foi utilizada a ferramenta **ChatGPT**, da OpenAI, como apoio na organização e revisão do material fornecido pelo grupo.

### Item 1 — Organização e estruturação do README

| Item                                 | Descrição                                                                                                                                                                                                                                               |
| ------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Ferramenta e etapa**               | ChatGPT — organização dos requisitos e elaboração do README da Entrega 1                                                                                                                                                                                |
| **Motivação**                        | Organizar as informações previamente levantadas pelo grupo de acordo com a estrutura exigida pelo professor                                                                                                                                             |
| **Prompt(s) utilizados**             | "preciso fazer a entrega desse trabalho, segue esqueleto da entrega com instruções do que deve ser feito e algumas informações já coletadas por outro membro do meu grupo"                                                                              |
| **Resposta recebida**                | A IA analisou o esqueleto da entrega e as informações do escritório e estruturou o conteúdo nas seções solicitadas                                                                                                                                      |
| **Fontes consultadas e verificadas** | As informações utilizadas foram comparadas com o material fornecido pelo grupo                                                                                                                                                                          |
| **Trechos rejeitados ou corrigidos** | Informações que não estavam presentes no material fornecido não foram apresentadas como fatos da organização. Evidências, como endereço, telefone e fotos, foram deixadas para preenchimento pelo grupo                                                 |
| **Justificativa da escolha final**   | O conteúdo foi mantido quando estava de acordo com as informações levantadas pelo grupo e adaptado para atender à estrutura do README                                                                                                                   |
| **Reflexão crítica**                 | A IA foi utilizada como ferramenta de organização e apoio à escrita, e não como substituta da pesquisa de campo. Informações sobre a organização devem ser confirmadas pelo grupo, principalmente aquelas que não estavam presentes no material inicial |

### Item 2 — Apoio à modelagem conceitual

| Item                                 | Descrição                                                                                                                                                                                                   |
| ------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Ferramenta e etapa**               | ChatGPT — organização da modelagem conceitual e justificativa técnica                                                                                                                                       |
| **Motivação**                        | Transformar os processos e regras de negócio levantados em uma estrutura conceitual coerente para o DER                                                                                                     |
| **Prompt(s) utilizados**             | "pode fazer por favor" após o envio do esqueleto da entrega e do levantamento realizado pelo grupo                                                                                                          |
| **Resposta recebida**                | A IA organizou as entidades, atributos, relacionamentos, cardinalidades e justificativas técnicas a partir do material fornecido                                                                            |
| **Fontes consultadas e verificadas** | O material produzido foi baseado principalmente nos documentos fornecidos pelo grupo                                                                                                                        |
| **Trechos rejeitados ou corrigidos** | Pontos que dependiam de informações não presentes nos documentos foram tratados como itens a complementar ou como proposta de modelagem                                                                     |
| **Justificativa da escolha final**   | A estrutura foi organizada para representar os processos identificados na organização e facilitar a continuidade do projeto                                                                                 |
| **Reflexão crítica**                 | A modelagem sugerida pela IA deve ser revisada pelo grupo e comparada com os processos reais observados na organização. Cardinalidades e relacionamentos devem ser confirmados antes da versão final do DER |

---

## Critérios Atitudinais

Os critérios de participação, comprometimento, colaboração e autonomia serão avaliados por meio da avaliação 360º dos integrantes do grupo e pelo histórico de commits do repositório GitHub.
...
* `README.md` completo;
* DER anexado como imagem;
* Fluxogramas dos principais processos;
* Evidências da existência da organização e da pesquisa de campo.

Os dados pessoais utilizados para exemplificar o sistema devem ser fictícios e não devem ser incluídos dados reais de clientes, devedores ou funcionários.
